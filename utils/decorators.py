...
def required_params(request_attr='query_params', params=None):
    ...
    这个required——paras 函数应该需要返回一个 decorator 函数， 这个 decorator 函数的参数
    就是被 @required_paras 包裹起来的函数 view_func
    """
    ...
    def decorator(view_func):
        """
        decorator 函数通过 wraps来将 view_func 里的参数解析出来传递给 _wrapped_view
        ...
        def _wrapped_view(instance, request, *args, **kwargs):
            ...
            # 做完检测之后， 再去调用被 @required_params包裹起来的 view_func
